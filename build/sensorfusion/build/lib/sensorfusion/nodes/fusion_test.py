...
class FusionNode(Node):
    ...
    def __init__(self):
        ...
        # ---------- EXTRINSICS ----------
        # ---------- EXTRINSICS ----------
        # We are going back to your CALIBRATED matrix because it contains the exact 
        # Pitch and Yaw angles of your physical mount. 
        T_calibrated = np.array([
        ...
        # Invert it ONCE here so it maps Lidar -> Camera Optical cleanly
        self.T_lidar_to_cam = np.linalg.inv(T_calibrated)
    ...
    def try_fuse(self):
        ...
        for i, det in enumerate(self.detections.detections):
            ...
            for idx, p_l in enumerate(lidar_points):
                ...
                margin = 25.0  # Adjust this: higher = more slack, lower = stricter
                ...
                # Check if point falls inside the EXPANDED box
    ...
    def project_lidar_point(self, p_l):
        ...
        # 1. Transform LiDAR -> Camera Optical Frame
        p_c = self.T_lidar_to_cam @ p_h 
        x_c, y_c, z_c = p_c[:3]
        ...
        # ---------- FINAL TWEAKS ----------
        # If the dots are consistently slightly off across the WHOLE screen,
        # adjust these flat pixel shifts. Do NOT add angles here.
        u_shift = 0.0  # Increase to shift dots Right
        v_shift = 0.0  # Increase to shift dots Down
