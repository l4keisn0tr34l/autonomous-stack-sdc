...
bool sdc_msgs__msg__arr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdc_msgs.msg._arr.Arr", full_classname_dest, 21) == 0);
  }
  sdc_msgs__msg__Arr * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Arr */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdc_msgs.msg._arr");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Arr");
